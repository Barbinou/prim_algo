...
while partie != "STOP":
    ...
    # ---- deuxième partie ----#
        ...
        graphe_object = Graphe(3, [Arete(1, 1, 2), Arete(1, 2, 4), Arete(1, 3, 5), Arete(2, 1, 1), Arete(2, 2, 3),
                                   Arete(2, 3, 4), Arete(3, 1, 2), Arete(3, 2, 1), Arete(3, 3, 6)])
    ...
    # ---- Dernière partie ----#
        ...
        graphe_object = Graphe(4, [Arete(1, 1, 2), Arete(1, 3, 4), Arete(2, 2, 5), Arete(2, 1, 1), Arete(3, 2, 4),
                                   Arete(3, 3, 2), Arete(4, 1, 1), Arete(4, 4, 3)])
        graphe = adjacence(graphe_object)
